...
Добавить `"./vendor/4geo35/editable-gallery-block/src/resources/views/livewire/admin/**/*.blade.php",
        "./vendor/4geo35/editable-gallery-block/src/resources/views/admin/**/*.blade.php",` в `tailwind.admin.config.js`, созданный в пакете `tailwindcss-theme`.
